 ...
 * This file demonstrates how to integrate Oracletorch with a web frontend
 */

// For React/Vue/Angular applications
export class OracletorchClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new OracletorchClient(provider, contractAddress);

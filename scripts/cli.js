...
const contractABI = require("../artifacts/contracts/Oracletorch.sol/Oracletorch.json").abi;

program
    .name("oracletorch-cli")
    .description("CLI tool for Oracletorch smart contract")
    .version("1.0.0");
